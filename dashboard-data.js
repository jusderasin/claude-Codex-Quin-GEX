...
nextPanel.querySelector('h2').textContent = 'Démarrer VXN';
nextPanel.querySelector('.badge').textContent = 'VXX COMPLET';
nextPanel.querySelector('.badge').classList.remove('amber');
nextPanel.querySelector('p').textContent = 'Les quatre lots VXX sont consolidés. Prochaine collecte : VXN, puis ingestion NQ1! et backtests chronologiques.';
nextPanel.querySelector('.progress span').style.width = '100%';
nextPanel.querySelector('small').textContent = '200 sessions VXX · 199 closes · 2 flags qualité';
