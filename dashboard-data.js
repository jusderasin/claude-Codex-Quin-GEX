...
dashboardMetrics[0].querySelector('strong').textContent = '400';
dashboardMetrics[0].querySelector('small').textContent = 'ES 50 · VXX 200 · 150 lignes à reclassifier';
dashboardMetrics[2].querySelector('strong').textContent = '5';

nextPanel.querySelector('h2').textContent = 'Identifier 150 lignes';
nextPanel.querySelector('.badge').textContent = 'CONFLIT DÉTECTÉ';
nextPanel.querySelector('.badge').classList.remove('amber');
nextPanel.querySelector('p').textContent = 'Les 50 clôtures ES sont propres. L’ancien fichier nommé ES1! affiche toutefois des prix incompatibles sur les mêmes dates : aucune fusion automatique.';
nextPanel.querySelector('.progress span').style.width = '100%';
nextPanel.querySelector('small').textContent = '50 clôtures ES isolées · 150 anciennes lignes exclues de toute analyse ES';
